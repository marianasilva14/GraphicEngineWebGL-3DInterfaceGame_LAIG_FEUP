...
MyPatch.prototype.init = function (application) {
...
MyPatch.prototype.initLights = function () {
...
MyPatch.prototype.initCameras = function () {
    this.camera = new CGFcamera(0.4, 0.1, 500, vec3.fromValues(0, 0, 50), vec3.fromValues(0, 0, 0));
};

MyPatch.prototype.setDefaultAppearance = function () {
